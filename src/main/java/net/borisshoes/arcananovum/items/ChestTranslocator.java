...
public class ChestTranslocator extends EnergyItem {
   ...
   public ChestTranslocator(){
      ...
      loreList.add(NbtString.of("[{\"text\":\"Sneak Right Click\",\"italic\":false,\"color\":\"dark_red\"},{\"text\":\" a \",\"color\":\"gray\"},{\"text\":\"chest \",\"color\":\"gold\"},{\"text\":\"to \",\"color\":\"gray\"},{\"text\":\"store \",\"color\":\"red\"},{\"text\":\"it in the \",\"color\":\"gray\"},{\"text\":\"Translocater\",\"color\":\"gold\"},{\"text\":\".\",\"color\":\"gray\"},{\"text\":\"\",\"color\":\"dark_purple\"}]"));
