...
public class catalyst_exotic extends MagicItem {
   
   public catalyst_exotic(){
      id = "catalyst_exotic";
      name = "Exotic Upgrade Catalyst";
      ...
      display.putString("Name","[{\"text\":\"Exotic Upgrade Catalyst\",\"italic\":false,\"color\":\"aqua\",\"bold\":true}]");
