...
public abstract class MagicPolymerPickaxeItem extends PickaxeItem implements PolymerItem {
   protected MagicItem magicItem;
   public MagicPolymerPickaxeItem(MagicItem magicItem, ToolMaterial material, int attackDamage, float attackSpeed, Settings settings){
