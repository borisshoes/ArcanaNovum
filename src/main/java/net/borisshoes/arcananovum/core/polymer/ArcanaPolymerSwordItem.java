...
public abstract class ArcanaPolymerSwordItem extends SwordItem implements PolymerItem {
   ...
   public ArcanaPolymerSwordItem(ArcanaItem arcanaItem, ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings){
      super(toolMaterial, attackDamage, attackSpeed, settings.registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of(MOD_ID,arcanaItem.getId()))));
