...
public abstract class ArcanaPolymerShieldItem extends ShieldItem implements PolymerItem {
   protected final ArcanaItem arcanaItem;
   public ArcanaPolymerShieldItem(ArcanaItem arcanaItem, Settings settings){
