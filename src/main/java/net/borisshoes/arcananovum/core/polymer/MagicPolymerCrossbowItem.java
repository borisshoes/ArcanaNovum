...
public abstract class MagicPolymerCrossbowItem extends CrossbowItem implements PolymerItem {
   protected MagicItem magicItem;
   public MagicPolymerCrossbowItem(MagicItem magicItem, Settings settings){
      super(settings);
