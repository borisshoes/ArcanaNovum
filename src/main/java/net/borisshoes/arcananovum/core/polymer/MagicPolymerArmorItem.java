...
public abstract class MagicPolymerArmorItem extends ArmorItem implements PolymerItem {
   protected MagicItem magicItem;
   public MagicPolymerArmorItem(MagicItem magicItem, ArmorMaterial material, Type type, Settings settings){
