...
public abstract class MagicPolymerSwordItem extends SwordItem implements PolymerItem {
   protected MagicItem magicItem;
   public MagicPolymerSwordItem(MagicItem magicItem, ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings){
