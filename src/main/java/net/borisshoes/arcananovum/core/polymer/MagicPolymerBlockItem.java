...
public abstract class MagicPolymerBlockItem extends BlockItem implements PolymerItem {
   protected MagicItem magicItem;
   public MagicPolymerBlockItem(MagicItem magicItem, Block block, Settings settings){
